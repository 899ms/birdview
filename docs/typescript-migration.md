...
| 4: distribution | Implemented and locally verified | PR #21 site/bootstrap; #22 typed tests, explicit artifact inventory, clean archive installation and CI browser/platform gates |
